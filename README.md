...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>I enjoy taking ownership across frontend, backend, APIs, data models, and workflows so the final product feels cohesive end to end.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>Automation That Reduces Friction</h3>
      <p>I like building systems that remove repetitive work, improve consistency, and help teams move faster without adding unnecessary complexity.</p>
    </td>
    <td width="50%" valign="top">
...
![Tailwind CSS](https://img.shields.io/badge/Tailwind-111827?style=flat-square&logo=tailwind-css&logoColor=38BDF8)
...
flowchart LR
    ...
    B --> C[Interface and UX]
    C --> D[Backend and Data]
    D --> E[AI or Automation Layer]
    E --> F[Ship, Measure, Iterate]
```
